...
import FoldedPalindrome (isNotAlpha, hasAlpha, takeUntil)
...
case_hasAlpha_3 = do True @=? hasAlpha "!#¤%&a()"
case_hasAlpha_4 = do True @=? hasAlpha "+-*/Ä,. "
case_hasAlpha_5 = do True @=? hasAlpha "AllAlpha"
